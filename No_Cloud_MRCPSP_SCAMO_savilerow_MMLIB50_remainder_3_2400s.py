...
def run_batch_MMLIB50(
    data_dir="data/MMLIB50_remainder_3",
    out_dir="result/MMLIB50_remainder_3",
    timeout_s=2400,
    gcs_bucket: str | None = None,
    gcs_prefix: str | None = "result/MMLIB50_remainder_3",
):
    """
...
if __name__ == "__main__":
    ...
    run_batch_MMLIB50(
        ...
        timeout_s=2400,
        gcs_bucket="mrcpsp",
        gcs_prefix="result/MMLIB50_remainder_3"
    )
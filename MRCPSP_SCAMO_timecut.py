...
class MRCPSPBlockBasedStaircase:
    ...
    def encode(self, makespan=None):
        ...
        self.create_variables(time_limit=makespan)
        ...
        self.add_process_variable_constraints(time_limit=makespan)

        print("Adding renewable resource constraints...")
        self.add_renewable_resource_constraints(time_limit=makespan)

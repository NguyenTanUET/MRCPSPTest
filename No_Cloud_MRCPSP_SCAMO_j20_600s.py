...
Batch runner: quét toàn bộ .mm trong data/j20, giải với timeout 600s/instance,
ghi CSV định kỳ 10 dòng/lần vào result/j20/.
"""
...
# ==========================
def run_batch_j20(data_dir="data/j20", out_dir="result/j20", timeout_s=600):
    ...
    csv_file = out_path / f"MRCPSP_j20_results_{ts}.csv"
